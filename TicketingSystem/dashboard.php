	          ...
	          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
	            <h4 class="h4">Dashboard</h4>
	            	...
	            	<article class="card-body mx-auto" style="max-width: 400px;">
	            			<h4 class="card-title mt-3 text-center">Your Information</h4>
	            			<div class="form-group input-group">
	            				<div class="input-group-prepend">
	            				    <span class="input-group-text"> <i class="fa fa-user"></i> </span>
	            				 </div>
	            		        <p name="fullname" class="form-control"><b><?=$_SESSION['fullname']?></b>
	            		    </div> <!-- form-group// -->
	            		    ...
	            		    <div class="form-group input-group">
	            		        ...
	            		        <p name="email" class="form-control"><b><?=$_SESSION['email']?></b>
	            		    </div>
	            		    ...
	            		    <div class="form-group input-group">
	            				...
	            				<p name="mobile_number" class="form-control"><b><?=$_SESSION['mobile_number']?></b>
	            			</div>
	            			...
	            			<div class="form-group input-group">
	            		        ...
	            		        <p name="NID" class="form-control"><b><?=$_SESSION['NID']?></b>
	            		    </div> <!-- form-group// -->
	          		</div>

...
if (isset($_POST['submit'])) {
	...
	if($fullname && $email && $mobile_number && $NID && $password){
		$sql = "INSERT INTO user VALUES(NULL, '$fullname', '$NID', '$mobile_number', '$email', '$password')";
...
<!-- 	              <li class="nav-item">
	...
	<article class="card-body mx-auto" style="max-width: 400px;">
		    ...
		    <div class="form-group input-group">
				...
				<input name="mobile_number" class="form-control" placeholder="Phone number" type="text">
			</div>
			...
			<div class="form-group input-group">
		        ...
		        <input name="NID" class="form-control" placeholder="NID" type="text">
		    </div> <!-- form-group// -->
